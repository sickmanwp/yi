...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3535497e17e0d188c010b00bd553641787283f3463eeaa673a5176aa808ee330.js',function(){input.required=false;search();});}
